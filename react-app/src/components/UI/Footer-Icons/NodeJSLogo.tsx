...
import styles from './NodeJSLogo.module.css';

const NodeJSLogo = () => {
  const { theme } = useContext(ThemeContext);

  const genericColor = theme === 'light' ? '#333' : '#fff';

  return (
    <a
      className={styles['nodejs-link']}
      target='_blank'
      rel='noopener noreferrer'
      href='https://nodejs.org/'
    >
      <svg
        id={styles['nodejs-svg']}
        xmlns='http://www.w3.org/2000/svg'
        viewBox="0 0 442.37 270.929"
      >
        <title>{'NodeJS (link)'}</title>
        <defs>
          <linearGradient
            id='nodejs-path_b'
            x1={-0.348}
        ...
        />
        <g clipPath='url(#nodejs-path_a)' transform='translate(-78.306 -164.016)'>
          <path
            fill='url(#nodejs-path_b)'
            d='m331.363 246.793-118.715-58.19-60.87 124.174L270.49 370.97zm0 0'
          />
        </g>
        <g clipPath='url(#nodejs-path_c)' transform='translate(-78.306 -164.016)'>
          <path
            fill='url(#nodejs-path_d)'
            d='m144.07 264.004 83.825 113.453 110.86-81.906-83.83-113.45zm0 0'
          />
        </g>
        <g clipPath='url(#nodejs-path_e)' transform='translate(-78.306 -164.016)'>
          <path fill='url(#nodejs-path_f)' d='M197.02 225.934v107.43h91.683v-107.43zm0 0' />
        </g>
      </svg>
    </a>
  );
