export const aboutConclusionText = `
  ...
  Jokes aside, I really think I've learned a lot writing these articles - that was _by far_ ***THE MOST*** difficult
  ...
  actually evaluate how much you know about that subject. In fact, I'm not embarrassed to say that I was able to catch
  some mistakes in my code when I started this process of writing, and I can honestly say that doing this really
  ...
  If you are a developer, I wanted to bring you some content that is not specific to a particular programming
  ...
  Using this perspective, no work is ever finished, is it? We can always improve it... But is also important to move on
