export const mapCoordinates1 = `
  ## Map Coordinates Problem
...
// image 13 - like image 8 with a few tweaks

export const mapCoordinates14 = `
  #### Seventh Step
