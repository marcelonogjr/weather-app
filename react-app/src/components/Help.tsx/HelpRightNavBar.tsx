...
import styles from './HelpRightNavBar.module.css';

interface HelpRightNavBarPropsType {
  articleSpecifics: {
    headingSections: {
      id: string;
      title: string;
...
const HelpRightNavBar = (props: HelpRightNavBarPropsType) => {
  ...
  return (
    <aside className={styles['help-right_nav_bar']}>
      <nav>
...
export default HelpRightNavBar;