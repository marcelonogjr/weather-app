  ...
  return (
    <>
      <p>
        ...
        , is an important indicator in weather forecast predictions. In this
      ...
      <p>
        Its purpose, as the name suggests, is to estimate the probability of
        precipitation - rain or snow - at any point of a certain location for a
        specified time. The calculation of the probability is given by:
      </p>
